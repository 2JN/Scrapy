...
connection.query("DELETE FROM programa WHERE canal_idcanal = 12");
...
var url = "http://www.gatotv.com/canal/golden"
  ...
  if (data){
    ...
    $("tr.tbl_EPG_row").each(function(i,e){
      ...
      if (program.trim() == ""){
        ...
        var programa = {idprograma: id, nombre: program.trim(), horaDeInicio: time, canal_idcanal: 12};
      ...
      if (movie.trim() == ""){
        ...
        var programa = {idprograma: id, nombre: movie.trim(), horaDeInicio: time, canal_idcanal: 12};
        connection.query("INSERT INTO programa SET ?", programa);
        connection.commit();
      }
