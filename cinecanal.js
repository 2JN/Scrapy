...
connection.query("DELETE FROM programa WHERE canal_idcanal = 8");
...
var url = "http://www.gatotv.com/canal/cinecanal"
  ...
  if (data){
    ...
    $("tr.tbl_EPG_row").each(function(i,e){
      ...
      if (program.trim() == ""){
        ...
        var programa = {idprograma: id, nombre: program.trim(), horaDeInicio: time, canal_idcanal: 8};
      ...
      if (movie.trim() == ""){
        ...
        var programa = {idprograma: id, nombre: movie.trim(), horaDeInicio: time, canal_idcanal: 8};
        connection.query("INSERT INTO programa SET ?", programa);
        connection.commit();
      }
